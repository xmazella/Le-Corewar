...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/04/04 11:17:36 by lbrangie          #+#    #+#             */
/*   Updated: 2018/09/26 08:26:55 by lbrangie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void		ptf_get_hex(t_flags *flags, t_conv *h, va_list ap)
{
	h->n_sign[0] = '\0';
	h->n_sign[1] = '\0';
	h->n_sign[2] = '\0';
