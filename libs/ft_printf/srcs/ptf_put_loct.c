...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/04/06 11:57:51 by lbrangie          #+#    #+#             */
/*   Updated: 2018/09/26 08:27:21 by lbrangie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void		ptf_get_loct(t_flags *flags, t_conv *o, va_list ap)
{
	o->n_sign[0] = '\0';
	o->n_sign[1] = '\0';
	o->n_sign[2] = '\0';
	o->n_tmp = va_arg(ap, unsigned long);
